...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions.append(Transaction(self.tran_id, self.balance, self.balance + amount))
        self.tran_id += 1
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.tran_id, self.balance, self.balance))
            self.tran_id += 1
